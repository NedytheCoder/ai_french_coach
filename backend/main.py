"""
AI French Coach - Backend API
==============================

This FastAPI application provides the backend services for the AI French Coach
language learning application. It handles AI-powered tutoring conversations,
audio transcription, and specialized practice modes.
...
- OpenAI: GPT-4o-mini for tutoring and Whisper for transcription
...
# This includes OPENAI_API_KEY for API authentication
load_dotenv()
